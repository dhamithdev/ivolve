    ...
    return (<div class="mx-20 ">
        <section class="">
            ...
            <div class="mt-16 flex flex-wrap justify-between mb-40">
                ...
                <div class="w-[30%] h-auto rounded-3xl bg-[#FEFAFF] pb-1 border-[1px]">
                <div class="mx-4 ">
                        <div class="flex justify-center w-full">
                            <Image layout="constrained" src={"/assets/images/discoverySection/cards/card2.svg"} alt="card 2 image" width={369} height={338} class="mt-5" />
                        </div>
                        <div class="flex justify-center  flex-col w-full pb-5">
                        <div>
                        <span class="text-[#1B123B] font-GeistMono600 text-start text-[24px] mt-3">Discover</span>
                        
                        <p class="text-[#1B123B] font-Fixel400 text-start text-base w-auto mt-2 ">Embark on a journey with us as we delve into the heart of your project. Through a meticulous Discovery & Needs Assessment, we unravel your vision, ensuring every detail is captured.</p>
                        </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-[30%] h-auto rounded-3xl bg-[#F2FFFA] pb-1 border-[1px]">
                <div class="mx-4">
                        <div class="flex justify-center w-full">
                            <Image layout="constrained" src={"/assets/images/discoverySection/cards/card2.svg"} alt="card 2 image" width={369} height={338} class="mt-5" />
                        </div>
                        ...
                        <div>
                            <span class="text-[#1B123B] font-GeistMono600 text-start text-[24px] mt-3">Crafting Possibilities</span>
                        
                            <p class="text-[#1B123B] font-Fixel400 text-start text-base w-auto mt-2 ">Explore possibilities with our expertise, working together to sculpt your Vision. We blend creativity and precision, shaping ideas into a solid plan through budget and timeline.</p>
                        </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-[30%] h-auto rounded-3xl bg-[#FFFAF7]  border-[1px]">
                <div class="m-4 ">
                        <div class="flex justify-center w-full">
                            <Image layout="constrained" src={"/assets/images/discoverySection/cards/card2.svg"} alt="card 2 image" width={369} height={338} class="" />
                        </div>
                        <div class="flex justify-center  flex-col w-full ">
                        
                            <span class="text-[#1B123B] font-GeistMono600 text-start text-[24px] mt-3">Seal the Promise / Craft</span>
                        
                            <p class="text-[#1B123B] font-Fixel400 text-start text-base w-auto mt-2 ">Watch as your vision unfolds. From meticulous execution to real-time progress updates, we ensure every step is a testament to the transformative results we craft together.</p>
