        ...
        <div>
            <div class="mb-24">
                <div class="flex gap-10">
                    ...
                    <div class="w-[50%] ">
                        <h5 class="text-[#494162] font-Fixel400 text-[24px] w-[600px] leading-snug pl-10">Dive into the chronicles of digital metamorphosis, where each case study narrates a unique tale of transformation and triumph.</h5>
                    </div>
                </div>
